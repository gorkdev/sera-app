<div class="relative">
    ...
    {{-- Backdrop --}}
    <div
        class="fixed inset-0 bg-base-content/40 backdrop-blur-sm z-40 transition-opacity duration-200 {{ $open ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none' }}"
        wire:click="toggle"
    ></div>
    ...
    >
                    ...
                    <ul class="space-y-3">
                        @foreach($cartItems as $item)
                            <li class="flex gap-3 items-center border-b border-base-300/60 pb-3 last:border-0 last:pb-0">
                                <div class="w-14 h-14 rounded-md bg-base-200 flex items-center justify-center overflow-hidden shrink-0">
                                    @if(!empty($item['image']))
                                        <img
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center gap-2 mt-1">
                                        ...
                                        <div class="relative cart-qty-group inline-flex items-center">
                                            <div
                                                class="join join-xs border border-base-300 rounded-md overflow-hidden inline-flex items-stretch"
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    wire:change="changeItemQuantity({{ $item['product_id'] }}, $event.target.value - {{ (int) $item['quantity'] }})"
                                                />
                                                <button
                                                    type="button"
        ...
        @if($showCheckoutModal)
            <div class="fixed inset-0 z-[60] flex items-center justify-center">
                ...
                ></div>
                <div class="relative bg-base-100 rounded-lg shadow-2xl border border-base-300 w-full max-w-md mx-4 p-5 z-[61]">
