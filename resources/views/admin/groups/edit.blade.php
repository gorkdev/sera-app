...
@section('title', 'Bayi Grubu Düzenle — ' . $group->name)
...
@section('content')
    <div class="admin-page-header mb-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-semibold">Bayi Grubu Düzenle</h1>
                <p class="mt-1 text-sm text-base-content/60">
                    Kod: <code class="bg-base-200 px-1.5 py-0.5 rounded text-xs">{{ $group->code }}</code>
                    @if($group->dealers_count > 0)
                        · <span class="text-warning">{{ $group->dealers_count }} bayi bu grupta</span>
                    @endif
                </p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.groups.update', $group) }}" class="admin-form space-y-6 max-w-3xl">
        @csrf
        @method('PUT')
        ...
        <section class="admin-form-section">
            ...
            <div class="alert alert-info mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm opacity-90">Grup Adı: Bayi listesinde görünecek isim. Kod: Teknik kod (büyük harf). Gecikme Süresi: Stok erişim gecikmesi (dakika). VIP: 0, Standart: 15, Yeni: 30.</p>
                </div>
            </div>
            <div class="space-y-4">
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" id="code" name="code" value="{{ old('code', $group->code) }}"
                ...
                <div class="form-control">
                    ...
                    <input type="number" id="delay_minutes" name="delay_minutes" value="{{ old('delay_minutes', $group->delay_minutes) }}"
                ...
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-3">
                        <input type="checkbox" name="is_default" value="1" class="checkbox checkbox-primary"
                            {{ old('is_default', $group->is_default) ? 'checked' : '' }} />
